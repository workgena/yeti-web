module Jobs
  class CallsMonitoring < ::BaseJob
    ...
    class CallCollection
      ...
      def where(destination_reverse_billing: nil, dialpeer_reverse_billing: nil)
        collection.select do |c|
          if destination_reverse_billing != nil
            c['destination_reverse_billing'] == destination_reverse_billing && c['check_account_balance']
          elsif dialpeer_reverse_billing != nil
            c['dialpeer_reverse_billing'] == dialpeer_reverse_billing && c['check_account_balance']
          end
        end
      end
      ...
      customers_active_calls.each do |acc_id, calls|
        ...
        if call_collection.exceed_min_balance?
          @terminate_calls.merge!(
            call_collection
              .where(destination_reverse_billing: false)
        ...
        if call_collection.exceed_max_balance?
          @terminate_calls.merge!(
            call_collection
              .where(destination_reverse_billing: true)
              .index_by { |c| c["local_tag"] }
          )
        end
      end
    ...
    def detect_vendors_calls_to_reject
      vendors_active_calls.each do |acc_id, calls|
        ...
        if call_collection.exceed_min_balance?
          @terminate_calls.merge!(
            call_collection
              .where(dialpeer_reverse_billing: true)
              .index_by { |c| c["local_tag"] }
          )
        end
        ...
        if call_collection.exceed_max_balance?
          @terminate_calls.merge!(
            call_collection
              .where(dialpeer_reverse_billing: false)
              .index_by { |c| c["local_tag"] }
          )
        end
      end
